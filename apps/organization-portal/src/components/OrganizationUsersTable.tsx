...
export const OrganizationUsersTable: React.FC<OrganizationUsersTableProps> = ({ orgId }) => {
      ...
      <CardContent>
        <Box sx={{ mb: 3 }}>
          <Typography variant="h5" gutterBottom>
            Organization Members ({data.stats.total_members})
          </Typography>
          ...
          <Box sx={{ display: 'flex', gap: 2, mb: 3, flexWrap: 'wrap' }}>
            <Card variant="outlined" sx={{ flex: '1 1 200px', minWidth: 200 }}>
              <CardContent sx={{ textAlign: 'center', py: 2 }}>
                <Typography variant="h6">{data.stats.admin_count}</Typography>
                <Typography variant="body2" color="text.secondary">Admins</Typography>
              </CardContent>
            </Card>
            <Card variant="outlined" sx={{ flex: '1 1 200px', minWidth: 200 }}>
              <CardContent sx={{ textAlign: 'center', py: 2 }}>
                <Typography variant="h6">{data.stats.user_count}</Typography>
                <Typography variant="body2" color="text.secondary">Users</Typography>
              </CardContent>
            </Card>
            <Card variant="outlined" sx={{ flex: '1 1 200px', minWidth: 200 }}>
              <CardContent sx={{ textAlign: 'center', py: 2 }}>
                <Typography variant="h6">{data.stats.active_members}</Typography>
                <Typography variant="body2" color="text.secondary">Active</Typography>
              </CardContent>
            </Card>
            <Card variant="outlined" sx={{ flex: '1 1 200px', minWidth: 200 }}>
              <CardContent sx={{ textAlign: 'center', py: 2 }}>
                <Typography variant="h6">{data.stats.total_members}</Typography>
