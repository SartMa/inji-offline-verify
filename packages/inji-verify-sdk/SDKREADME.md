...
| `ldp_vc` | `RsaSignature2018*` | RSA PKCS#1 v1.5 with SHA-256| `jsonld-signatures`<br/> Browser `Web Crypto` API Custom RSA verifier | Requires cached PEM/JWK material. Relies on online fetch fallback, offline verification not available. | Verified |
